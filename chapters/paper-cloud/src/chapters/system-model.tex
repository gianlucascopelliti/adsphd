...
\begin{figure}[t]
  \centering
    \includegraphics[width=.9\columnwidth]{figures/attestation-flow.drawio.pdf}
  \caption[High-level attestation flow]{High-level attestation flow.}
...
\paragraph{AL1: Attested \ac{TEE} isolation}
%
...
\begin{figure}[t]
  ...
  \caption[Hierarchy of attestation levels for CVMs]{Hierarchy of attestation levels for \acsp{CVM}.}
  \label{fig:attestation-levels}
\end{figure}

\paragraph{AL2: Measured firmware}
%
...
\paragraph{AL4: Fully measured boot}
%
...
\begin{figure}[t]
  \centering
    \includegraphics[width=.9\columnwidth]{figures/partial-attestation.drawio.pdf}
  \caption[Possible Man-in-the-Middle attack with an unverified guest OS]{Possible Man-in-the-Middle attack with an unverified guest OS.}
