...
\begin{tikzpicture}[thick]
  ...
  \draw [decorate, decoration = {calligraphic brace, mirror}] (0.1*9,-0.5) -- (0.60*9,-0.5) node[midway,below,draw=none]{\small$\paramtt$};
  \draw [decorate, decoration = {calligraphic brace, mirror}] (0.6*9,-0.5) -- (0.99*9,-0.5) node[midway,below,draw=none]{\small$\paramtt$};

  \draw [->] (0.1*9, 0.5) -- +(0,-0.4) node[above=-6.57pt,draw=none, align=center, font=\scriptsize]{last usable\\HB generated};
  \draw [->] (0.3*9, 0.5) -- +(0,-0.4) node[above=-1pt,draw=none, align=center, font=\scriptsize]{vehicle $v_i$\\is revoked};
  \draw [->] (0.6*9, 0.5) -- +(0,-0.4) node[above=-13pt,draw=none, align=center, font=\scriptsize]{expiry date for\\ $v_i$'s V2V messages};
  \draw [->] (0.9*9, 0.5) -- +(0,-0.4) node[above=-17pt,draw=none, align=center, font=\scriptsize]{V2V message from $v_i$\\processed by $v_j$};
...
\caption[Timeline diagram showing relations between \paramtt{} and \paramteff{}]{Timeline diagram showing times from \cref{section:design-properties}
