...
\begin{figure}
    ...
    \caption[A graph of the Markov chain with exemplary parameters]{A graph of the Markov chain with the exemplary parameters of $n=3$, $p=0.1$, and $T_{prl}=2$.}
...
\begin{figure}[t]
    ...
    \caption[99th percentile PRL sizes for fixed $T_{prl}=30$ and varying $n$]{99th percentile PRL sizes for fixed $T_{prl}=30$ and varying number of pseudonyms ($n$) under four scenarios.}
...
\begin{figure}[t]
    ...
    \caption[99th percentile PRL sizes for fixed $n=800$ and varying $T_{prl}$]{99th percentile PRL sizes for fixed $n=800$ pseudonyms and varying $T_{prl}$ under four scenarios.}
