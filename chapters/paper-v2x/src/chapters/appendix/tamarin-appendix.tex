...
\begin{itemize}
    ...
    \tamrule{HeartbeatProcessed(HB,t)} action fact is produced, along with a
...
\subsection{Trusted Time Source in TCs}

\input{tables/lemmas-trusted-time.tex}

\sclist{0.7}{%
  \lstinputlisting[language=Tamarin]{properties-time.spthy}}{Properties of our
  design with trusted time in \tamarin{}}%
  {Properties of our design with a trusted time source in \ac{TC}
  translated to \tamarin{} lemmas.}%
  {listing:tamarin-lemmas-time} 
