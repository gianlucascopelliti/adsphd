\sclist{0.58}{%
  \lstinputlisting[language=Python]{setkey.py}}{Pseudocode of the \setkey{} entry point}%
...
%
\sclist{0.58}{%
  \lstinputlisting[language=Python]{handleinput.py}}{Pseudocode of the \handleinput{} entry point}%
...
%
\sclist{0.58}{%
  \lstinputlisting[language=Python]{handleoutput.py}}{Pseudocode of the generated output wrapper}%
...
%
\sclist{0.58}{%
  \lstinputlisting[language=Python]{attest.py}}{Pseudocode of the \attest{} entry point}%
