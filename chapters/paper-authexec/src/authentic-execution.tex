...
\subsection{Underlying Architecture: TEEs}
\label{design:tee}
%
...
\subsection{Mapping Source Modules to SMs}
...
\sclist{0.5}{\maxsizebox{\linewidth}{!}{\input{compiled-pm.tex}}}{Memory layout of module
\module{FloS1} in application \appvio{}}{%
