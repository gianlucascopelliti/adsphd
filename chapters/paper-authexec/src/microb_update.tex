...
\begin{table}
  ...
  \begin{tabular}{ | x{3cm} | x{3cm} | x{1.5cm} | x{1.5cm} | x{1.5cm} | x{1.5cm} | x{1.5cm} | }
    \hline
  ...
  \end{tabular}}
  \vspace{0.2cm}
  \caption[Average timings to perform a software update on different TEEs]{ Average time to perform a software update on different TEEs, all
