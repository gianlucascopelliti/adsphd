\documentclass[showinstructions,faculty=firw,department=cws,phddegree=cws,final]{adsphd}
...
%%% COVER: Settings %%%
\title{Secure Integration of Trusted Execution Environments into Distributed Applications}
%\title{Principled Integration of Trusted Computing into Distributed Applications}

\author{Gianluca}{Scopelliti}

\supervisor{Prof.~dr.~ir.~W.~Joosen}{}
\supervisor{Prof.~dr.~J.~T.~M\"{u}hlberg}{}
\supervisor{Dr.~ir.~C.~Baumann}{}
\president{Prof.~dr.~ir.~J.~De Schutter}{}
\jurymember{Dr.~E.~Truyen}{}
\jurymember{Prof.~dr.~ir.~V.~Naessens}{}
\externaljurymember{Prof.~dr.~P.~Papadimitratos}{KTH Sweden}
\externaljurymember{Prof.~dr.~S.~Shinde}{ETH Zurich}
...
\usepackage[acronym,automake]{glossaries} % For list of abbreviations
\newcommand{\glossname}{List of Abbreviations}
\newcommand{\myprintglossary}{%
  \renewcommand{\glossaryname}{\glossname}
  \cleardoublepage%
  \printglossary[title=\glossname,type=\acronymtype,nonumberlist,nopostdot]
